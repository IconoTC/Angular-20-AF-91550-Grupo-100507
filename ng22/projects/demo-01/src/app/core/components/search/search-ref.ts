...
@Component({
  ...
  template: ` <input
      ...
      [(ngModel)]="text_input.value"
    />
    <span class="form-result">{{
      text_input.value === '' ? 'Esperando' : 'Buscando ' + text_input.value
    }}</span>
    <button type="reset" (click)="text_input.value = ''; text_input.focus()" title="Reset" aria-label="Clear">
      <svg
